...
describe('CHECK SWAG LABS LOG IN WITH POM', () => {
  ...
  // it('Validate empty user and empty password', () => {
  //   loginPage.clickLoginButton();
  ...
  // it('Validate empty user and correct password', () => {
  //   loginPage.typePasswordInput('secret_sauce');
  //   loginPage.clickLoginButton();
  ...
  // it('Validate wrong user and wrong password', () => {
  //   loginPage.typeUsernameInput('wrong_user');
  //   loginPage.typePasswordInput('wrong_password');
  //   loginPage.clickLoginButton();
  ...
  // it('Validate wrong user and correct password', () => {
  //   loginPage.typeUsernameInput('wrong_user');
  //   loginPage.typePasswordInput('secret_sauce');
  //   loginPage.clickLoginButton();
